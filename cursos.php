...
<body>
    ...
    <?php include __DIR__ . '/includes/sidebar.html'; ?>
     
    

    <div class="container-principal">
        <?php include __DIR__ . '/includes/barra-superior.html'; ?>
    ...
    <script>
        (() => {
            ...
            botaoIniciar.addEventListener('click', () => {
                ...
                window.location.href = `hub.php?nome=${encodeURIComponent(cursoAtual)}`;
            });
        })();
    </script>
</body>
