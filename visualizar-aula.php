...
<head>
    ...
    <?php
        // Dados da lista de conteúdos e materiais da aula: centralizados em dados.php
    ...
    <main class="page">
        ...
        <aside class="sidebar">
            ...
            <ul class="lesson-list">
                ...
                <?php foreach ($conteudos_aula_revolucao_1930 as $indice => $item): ?>
                    <li class="lesson-item<?= $item['ativo'] ? ' active' : '' ?>">

                        <?php if ($item['tipo'] === 'exercicio'): ?>
                            <span style="width:18px;">
                                <i class="bi bi-clipboard"></i>
                            </span>
                        <?php else: ?>
                            <span class="lesson-number"><?= $indice + 1 ?></span>
                        <?php endif; ?>

                        <span class="lesson-name"><?= htmlspecialchars($item['nome']) ?></span>
        ...
        <section class="content">
            ...
            <div class="materiais">
                ...
                <?php foreach ($materiais_aula_revolucao_1930 as $material): ?>
                    <div class="material-item">

                        <div class="material-icon">
                            <i class="bi <?= htmlspecialchars($material['icone']) ?>"></i>
                        </div>

                        <div class="material-info">
                            <div class="material-name"><?= htmlspecialchars($material['nome']) ?></div>
                            <div class="material-size"><?= htmlspecialchars($material['tamanho']) ?></div>
                        </div>

                        <div class="material-download">
                            <span class="material-download-text">Download</span>
                            <button
                                type="button"
