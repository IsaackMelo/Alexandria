<?php
// AVISO !! Este arquivo é um exemplo da estrutura do database.php sem a senha "para proteção", ao utilizar mude o nome para database.php e coloque a senha do banco.
$host = 'localhost';
