...
<body>
    ...
    <div class="button">
        <a id="redirecionamento" class="btn-login">
            Entrar &nbsp;
    ...
    <script>
        const botao = document.getElementById("redirecionamento");

        const paginaAnterior = document.referrer;

        if (paginaAnterior.includes("confirmacao.php")) {
            botao.href = "plano.php";
        } else {
            botao.href = "cursos.php";
        }
    </script>
